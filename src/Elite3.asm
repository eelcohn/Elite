...
1949  01 08              ..   ORA (&08,X)
194B  08                 .    PHP
194C  FE 00 FF           ...  INC &FF00,X
194F  7E 2C 02           ~,.  ROR &022C,X
1952  01 0E              ..   ORA (&0E,X)
1954  EE FF 2C           ..,  INC &2CFF
1957  20 32 06            2.  JSR &0632
195A  01 00              ..   ORA (&00,X)
195C  FE 78 7E           .x~  INC &7E78,X
195F  03                 .    ...
1960  01 01              ..   ORA (&01,X)
1962  FF                 .    ...
1963  FD 11 20           ..   SBC &2011,X
1966  80                 .    ...
1967  01 00              ..   ORA (&00,X)
1969  00                 .    BRK
196A  FF                 .    ...
...
196E  01 04              ..   ORA (&04,X)
1970  F8                 .    SED
1971  2C 04 06           ,..  BIT &0604
1974  08                 .    PHP
1975  16 00              ..   ASL &00,X
1977  00                 .    BRK
1978  81 7E              .~   STA (&7E,X)
197A  00                 .    BRK
197B  20 72 1B            r.  JSR &1B72
197E  A9 90              ..   LDA #&90
1980  A2 FF              ..   LDX #&FF
1982  20 26 1D            &.  JSR &1D26
1985  A9 00              ..   LDA #&00
1987  85 70              .p   STA &70
1989  A9 19              ..   LDA #&19
198B  85 71              .q   STA &71
198D  A0 00              ..   LDY #&00
.addr198F
198F  B1 70              .p   LDA (&70),Y
1991  20 EE FF            ..  JSR &FFEE
1994  C8                 .    INY
1995  C0 43              .C   CPY #&43
1997  D0 F6              ..   BNE &198F
1999  20 89 1B            ..  JSR &1B89
199C  A9 10              ..   LDA #&10
199E  A2 03              ..   LDX #&03
19A0  20 F4 FF            ..  JSR &FFF4
19A3  A9 60              .`   LDA #&60
19A5  8D 32 02           .2.  STA &0232
19A8  A9 02              ..   LDA #&02
19AA  8D 25 02           .%.  STA &0225
19AD  A9 32              .2   LDA #&32
19AF  8D 24 02           .$.  STA &0224
19B2  A9 BE              ..   LDA #&BE
19B4  A2 08              ..   LDX #&08
19B6  20 26 1D            &.  JSR &1D26
19B9  A9 C8              ..   LDA #&C8
19BB  A2 03              ..   LDX #&03
19BD  20 26 1D            &.  JSR &1D26
19C0  A9 0D              ..   LDA #&0D
19C2  A2 00              ..   LDX #&00
19C4  20 26 1D            &.  JSR &1D26
19C7  A9 E1              ..   LDA #&E1
19C9  A2 80              ..   LDX #&80
19CB  20 26 1D            &.  JSR &1D26
19CE  A9 DB              ..   LDA #&DB
19D0  85 9F              ..   STA &9F
19D2  EA                 .    NOP
19D3  EA                 .    NOP
...
19D5  A9 0D              ..   LDA #&0D
19D7  A2 02              ..   LDX #&02
19D9  20 26 1D            &.  JSR &1D26
19DC  A9 04              ..   LDA #&04
19DE  A2 01              ..   LDX #&01
19E0  20 26 1D            &.  JSR &1D26
19E3  A9 09              ..   LDA #&09
19E5  A2 00              ..   LDX #&00
19E7  20 26 1D            &.  JSR &1D26
19EA  20 E2 1C            ..  JSR &1CE2
19ED  A9 00              ..   LDA #&00
19EF  85 70              .p   STA &70
19F1  A9 11              ..   LDA #&11
19F3  85 71              .q   STA &71
...
1A0E  85 73              .s   STA &73
1A10  A2 08              ..   LDX #&08
1A12  20 39 1D            9.  JSR &1D39
1A15  78                 x    SEI
1A16  AD 44 FE           .D.  LDA &FE44
1A19  85 01              ..   STA &01
1A1B  A9 39              .9   LDA #&39
1A1D  8D 4E FE           .N.  STA &FE4E
1A20  A9 7F              .   LDA #&7F
1A22  8D 6E FE           .n.  STA &FE6E
1A25  AD 04 02           ...  LDA &0204
1A28  8D FE 7F           ..  STA &7FFE
1A2B  AD 05 02           ...  LDA &0205
1A2E  8D FF 7F           ..  STA &7FFF
1A31  A9 4B              .K   LDA #&4B
1A33  8D 04 02           ...  STA &0204
1A36  A9 11              ..   LDA #&11
1A38  8D 05 02           ...  STA &0205
1A3B  A9 39              .9   LDA #&39
1A3D  8D 45 FE           .E.  STA &FE45
1A40  58                 X    CLI
1A41  A9 00              ..   LDA #&00
1A43  85 70              .p   STA &70
1A45  A9 61              .a   LDA #&61
...
1A80  85 73              .s   STA &73
1A82  A2 04              ..   LDX #&04
1A84  20 39 1D            9.  JSR &1D39
1A87  A2 23              .#   LDX #&23
.addr1A89
1A89  BD 4F 1B           .O.  LDA &1B4F,X
1A8C  9D 7A 0D           .z.  STA &0D7A,X
1A8F  CA                 .    DEX
1A90  10 F7              ..   BPL &1A89
1A92  A5 76              .v   LDA &76
1A94  8D 92 0D           ...  STA &0D92
1A97  A2 43              .C   LDX #&43
1A99  A0 19              ..   LDY #&19
1A9B  A9 08              ..   LDA #&08
1A9D  20 F1 FF            ..  JSR &FFF1
1AA0  A2 51              .Q   LDX #&51
1AA2  A0 19              ..   LDY #&19
1AA4  A9 08              ..   LDA #&08
1AA6  20 F1 FF            ..  JSR &FFF1
1AA9  A2 5F              ._   LDX #&5F
1AAB  A0 19              ..   LDY #&19
1AAD  A9 08              ..   LDA #&08
1AAF  20 F1 FF            ..  JSR &FFF1
1AB2  A2 6D              .m   LDX #&6D
1AB4  A0 19              ..   LDY #&19
1AB6  A9 08              ..   LDA #&08
1AB8  20 F1 FF            ..  JSR &FFF1
1ABB  A2 44              .D   LDX #&44
1ABD  A0 1D              ..   LDY #&1D
1ABF  20 F7 FF            ..  JSR &FFF7
1AC2  A9 00              ..   LDA #&00
1AC4  85 70              .p   STA &70
1AC6  A9 0B              ..   LDA #&0B
1AC8  85 71              .q   STA &71
...
1AD2  A0 00              ..   LDY #&00
.addr1AD4
1AD4  B1 72              .r   LDA (&72),Y
1AD6  91 70              .p   STA (&70),Y
1AD8  C8                 .    INY
1AD9  C0 4F              .O   CPY #&4F
1ADB  D0 F7              ..   BNE &1AD4
1ADD  4C 00 0B           L..  JMP &0B00
1AE0  18                 .    CLC
1AE1  A0 00              ..   LDY #&00
.addr1AE3
1AE3  79 89 1B           y..  ADC &1B89,Y
1AE6  59 7B 19           Y{.  EOR &197B,Y
1AE9  88                 .    DEY
1AEA  D0 F7              ..   BNE &1AE3
1AEC  60                 `    RTS
1AED  A2 37              .7   LDX #&37
1AEF  A0 0B              ..   LDY #&0B
1AF1  20 F7 FF            ..  JSR &FFF7
1AF4  A9 EE              ..   LDA #&EE
1AF6  8D 02 02           ...  STA &0202
1AF9  A9 11              ..   LDA #&11
1AFB  8D 03 02           ...  STA &0203
1AFE  A9 E9              ..   LDA #&E9
1B00  8D 0E 02           ...  STA &020E
1B03  A9 11              ..   LDA #&11
1B05  8D 0F 02           ...  STA &020F
1B08  38                 8    SEC
1B09  A0 00              ..   LDY #&00
1B0B  84 70              .p   STY &70
1B0D  A2 11              ..   LDX #&11
...
.addr1B1F
1B1F  D0 FE              ..   BNE &1B1F
1B21  4C E6 11           L..  JMP &11E6
1B24  4C 2E 54           L.T  JMP &542E
1B27  2E 43 4F           .CO  ROL &4F43
1B2A  44                 D    ...
1B2B  45 0D              E.   EOR &0D
1B2D  44                 D    ...
1B2E  6F                 o    ...
1B2F  65 73              es   ADC &73
1B31  20 79 6F            yo  JSR &6F79
1B34  75 72              ur   ADC &72,X
1B36  20 6D 6F            mo  JSR &6F6D
1B39  74                 t    ...
1B3A  68                 h    PLA
1B3B  65 72              er   ADC &72
1B3D  20 6B 6E            kn  JSR &6E6B
1B40  6F                 o    ...
1B41  77                 w    ...
1B42  20 79 6F            yo  JSR &6F79
1B45  75 20              u    ADC &20,X
1B47  64                 d    ...
1B48  6F                 o    ...
1B49  20 74 68            th  JSR &6874
1B4C  69 73              is   ADC #&73
1B4E  3F                 ?    ...
1B4F  CE 9A 0D           ...  DEC &0D9A
1B52  CE 94 0D           ...  DEC &0D94
1B55  20 89 0D            ..  JSR &0D89
1B58  EE 9A 0D           ...  INC &0D9A
1B5B  EE 94 0D           ...  INC &0D94
1B5E  A9 7F              .   LDA #&7F
1B60  A2 92              ..   LDX #&92
1B62  A0 0D              ..   LDY #&0D
1B64  4C F1 FF           L..  JMP &FFF1
1B67  00                 .    BRK
1B68  00                 .    BRK
1B69  0F                 .    ...
1B6A  00                 .    BRK
...
1B7A  EA                 .    NOP
1B7B  EA                 .    NOP
1B7C  8D 87 1C           ...  STA &1C87
1B7F  09 00              ..   ORA #&00
1B81  10 02              ..   BPL &1B85
1B83  46 78              Fx   LSR &78
.addr1B85
1B85  4C CF 1C           L..  JMP &1CCF
1B88  AC AD 44           ..D  LDY &44AD
1B8B  FE 8D 86           ...  INC &868D,X
1B8E  1C                 .    ...
1B8F  20 6A 1C            j.  JSR &1C6A
1B92  20 89 1C            ..  JSR &1C89
1B95  85 71              .q   STA &71
1B97  A5 72              .r   LDA &72
1B99  85 70              .p   STA &70
1B9B  EA                 .    NOP
...
1B9E  EA                 .    NOP
1B9F  EA                 .    NOP
1BA0  20 6A 1C            j.  JSR &1C6A
1BA3  85 74              .t   STA &74
1BA5  20 89 1C            ..  JSR &1C89
1BA8  AA                 .    TAX
1BA9  A5 72              .r   LDA &72
1BAB  65 70              ep   ADC &70
1BAD  85 70              .p   STA &70
1BAF  8A                 .    TXA
1BB0  65 71              eq   ADC &71
1BB2  B0 1F              ..   BCS &1BD3
1BB4  85 71              .q   STA &71
1BB6  A9 01              ..   LDA #&01
1BB8  E5 70              .p   SBC &70
...
1BCD  C9 80              ..   CMP #&80
1BCF  6A                 j    ROR A
1BD0  20 A6 1C            ..  JSR &1CA6
.addr1BD3
1BD3  CE DC 1C           ...  DEC &1CDC
1BD6  D0 B1              ..   BNE &1B89
1BD8  CE DD 1C           ...  DEC &1CDD
1BDB  D0 AC              ..   BNE &1B89
.addr1BDD
1BDD  20 6A 1C            j.  JSR &1C6A
1BE0  AA                 .    TAX
1BE1  20 89 1C            ..  JSR &1C89
1BE4  85 71              .q   STA &71
1BE6  20 6A 1C            j.  JSR &1C6A
1BE9  85 74              .t   STA &74
1BEB  20 89 1C            ..  JSR &1C89
1BEE  65 71              eq   ADC &71
1BF0  C9 11              ..   CMP #&11
1BF2  90 05              ..   BCC &1BF9
1BF4  A5 74              .t   LDA &74
1BF6  20 A6 1C            ..  JSR &1CA6
.addr1BF9
1BF9  CE DE 1C           ...  DEC &1CDE
1BFC  D0 DF              ..   BNE &1BDD
1BFE  CE DF 1C           ...  DEC &1CDF
1C01  D0 DA              ..   BNE &1BDD
.addr1C03
1C03  20 6A 1C            j.  JSR &1C6A
1C06  85 70              .p   STA &70
1C08  20 89 1C            ..  JSR &1C89
1C0B  85 71              .q   STA &71
1C0D  EA                 .    NOP
1C0E  EA                 .    NOP
1C0F  EA                 .    NOP
1C10  EA                 .    NOP
1C11  EA                 .    NOP
1C12  20 6A 1C            j.  JSR &1C6A
1C15  85 74              .t   STA &74
1C17  20 89 1C            ..  JSR &1C89
1C1A  85 75              .u   STA &75
1C1C  65 71              eq   ADC &71
1C1E  85 71              .q   STA &71
1C20  A5 70              .p   LDA &70
1C22  C9 80              ..   CMP #&80
1C24  6A                 j    ROR A
1C25  C9 80              ..   CMP #&80
1C27  6A                 j    ROR A
1C28  65 74              et   ADC &74
1C2A  AA                 .    TAX
1C2B  20 89 1C            ..  JSR &1C89
1C2E  A8                 .    TAY
1C2F  65 71              eq   ADC &71
1C31  B0 18              ..   BCS &1C4B
1C33  C9 50              .P   CMP #&50
1C35  B0 14              ..   BCS &1C4B
1C37  C9 20              .    CMP #&20
...
.addr1C46
1C46  A5 74              .t   LDA &74
1C48  20 A6 1C            ..  JSR &1CA6
.addr1C4B
1C4B  CE E0 1C           ...  DEC &1CE0
1C4E  D0 B3              ..   BNE &1C03
1C50  CE E1 1C           ...  DEC &1CE1
1C53  D0 AE              ..   BNE &1C03
1C55  A9 00              ..   LDA #&00
1C57  85 70              .p   STA &70
1C59  A9 63              .c   LDA #&63
...
1C63  85 73              .s   STA &73
1C65  A2 08              ..   LDX #&08
1C67  20 2C 1D            ,.  JSR &1D2C
.addr1C6A
1C6A  AD 86 1C           ...  LDA &1C86
1C6D  AA                 .    TAX
1C6E  6D 88 1C           m..  ADC &1C88
1C71  8D 86 1C           ...  STA &1C86
1C74  8E 88 1C           ...  STX &1C88
1C77  AD 85 1C           ...  LDA &1C85
1C7A  AA                 .    TAX
1C7B  6D 87 1C           m..  ADC &1C87
1C7E  8D 85 1C           ...  STA &1C85
1C81  8E 87 1C           ...  STX &1C87
1C84  60                 `    RTS
1C85  49 53              IS   EOR #&53
1C87  78                 x    SEI
1C88  34                 4    ...
.addr1C89
1C89  10 05              ..   BPL &1C90
...
1C94  A9 00              ..   LDA #&00
1C96  A0 08              ..   LDY #&08
1C98  46 72              Fr   LSR &72
.addr1C9A
1C9A  90 03              ..   BCC &1C9F
1C9C  18                 .    CLC
1C9D  65 73              es   ADC &73
.addr1C9F
1C9F  6A                 j    ROR A
1CA0  66 72              fr   ROR &72
1CA2  88                 .    DEY
1CA3  D0 F5              ..   BNE &1C9A
1CA5  60                 `    RTS
.addr1CA6
...
1CBE  29 07              ).   AND #&07
1CC0  AA                 .    TAX
1CC1  BD C7 1C           ...  LDA &1CC7,X
1CC4  91 70              .p   STA (&70),Y
.addr1CC6
1CC6  60                 `    RTS
1CC7  80                 .    ...
1CC8  40                 @    RTI
1CC9  20 10 08            ..  JSR &0810
1CCC  04                 .    ...
1CCD  02                 .    ...
1CCE  01 AD              ..   ORA (&AD,X)
1CD0  87                 .    ...
1CD1  1C                 .    ...
1CD2  45 78              Ex   EOR &78
1CD4  0A                 .    ASL A
1CD5  C9 93              ..   CMP #&93
1CD7  6A                 j    ROR A
1CD8  85 78              .x   STA &78
...
.addr1D26
1D26  A0 00              ..   LDY #&00
1D28  4C F4 FF           L..  JMP &FFF4
1D2B  0E A0 00           ...  ASL &00A0
.addr1D2E
1D2E  B1 72              .r   LDA (&72),Y
1D30  49 A5              I.   EOR #&A5
1D32  91 70              .p   STA (&70),Y
1D34  88                 .    DEY
1D35  D0 F7              ..   BNE &1D2E
1D37  60                 `    RTS
1D38  0E 20 2C           . ,  ASL &2C20
1D3B  1D E6 71           ..q  ORA &71E6,X
1D3E  E6 73              .s   INC &73
1D40  CA                 .    DEX
1D41  D0 F6              ..   BNE &1D39
1D43  60                 `    RTS
1D44  2A                 *    ROL A
1D45  44                 D    ...
1D46  49 52              IR   EOR #&52
1D48  20 45 0D            E.  JSR &0D45
...
1E25  A5 A5              ..   LDA &A5
1E27  A5 A5              ..   LDA &A5
1E29  F0 5A              .Z   BEQ &1E85
1E2B  55 A5              U.   EOR &A5,X
1E2D  A5 A5              ..   LDA &A5
1E2F  A5 A5              ..   LDA &A5
1E31  F0 5A              .Z   BEQ &1E8D
1E33  55 A5              U.   EOR &A5,X
1E35  A5 A5              ..   LDA &A5
1E37  A5 A5              ..   LDA &A5
1E39  F0 5A              .Z   BEQ &1E95
