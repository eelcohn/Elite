...
; -----------------------------------------------------------------------------
.ship_shuttle_edges
	EQUB &1F, &02, &00, &04, &1F, &4A, &04, &08
	EQUB &1F, &6B, &08, &0C, &1F, &8C, &00, &0C
	EQUB &1F, &18, &00, &1C, &18, &12, &00, &10
	EQUB &1F, &23, &04, &10, &18, &34, &04, &14
	EQUB &1F, &45, &08, &14, &0C, &56, &08, &18
	EQUB &1F, &67, &0C, &18, &18, &78, &0C, &1C
	EQUB &1F, &39, &10, &14, &1F, &59, &14, &18
	EQUB &1F, &79, &18, &1C, &1F, &19, &10, &1C
	EQUB &10, &0C, &00, &30, &10, &0A, &04, &30
	EQUB &10, &AB, &08, &30, &10, &BC, &0C, &30
	EQUB &10, &99, &20, &24, &06, &99, &24, &28
	EQUB &08, &99, &28, &2C, &06, &99, &20, &2C
	EQUB &04, &BB, &34, &38, &07, &BB, &38, &3C
	EQUB &06, &BB, &34, &3C, &04, &AA, &40, &44
	EQUB &07, &AA, &44, &48, &06, &AA, &40, &48

; -----------------------------------------------------------------------------
; Faces data
; -----------------------------------------------------------------------------
.ship_shuttle_faces
	EQUB &DF, &6E, &6E, &50, &5F, &00, &95, &07
	EQUB &DF, &66, &66, &2E, &9F, &95, &00, &07
	EQUB &9F, &66, &66, &2E, &1F, &00, &95, &07
	EQUB &1F, &66, &66, &2E, &1F, &95, &00, &07
	EQUB &5F, &66, &66, &2E, &3F, &00, &00, &D5
	EQUB &9F, &51, &51, &B1, &1F, &51, &51, &B1
	EQUB &5F, &6E, &6E, &50
