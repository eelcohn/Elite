...
.ship_transporter_edges
	EQUB &1F, &07, &00, &04, &1F, &01, &04, &08
	EQUB &1F, &02, &08, &0C, &1F, &03, &0C, &10
	EQUB &1F, &04, &10, &14, &1F, &05, &14, &18
	EQUB &1F, &06, &00, &18, &0F, &67, &00, &1C
	EQUB &1F, &17, &04, &20, &0A, &12, &08, &24
	EQUB &1F, &23, &0C, &24, &1F, &34, &10, &28
	EQUB &0A, &45, &14, &28, &1F, &56, &18, &2C
	EQUB &10, &78, &1C, &20, &10, &19, &20, &24
	EQUB &10, &5A, &28, &2C, &10, &6B, &1C, &2C
	EQUB &12, &BC, &1C, &3C, &12, &8C, &1C, &30
	EQUB &10, &89, &20, &30, &1F, &39, &24, &34
	EQUB &1F, &3A, &28, &38, &10, &AB, &2C, &3C
	EQUB &1F, &9D, &30, &34, &1F, &3D, &34, &38
	EQUB &1F, &AD, &38, &3C, &1F, &CD, &30, &3C
	EQUB &06, &77, &40, &44, &06, &77, &48, &4C  ; I.B. on roof
	EQUB &06, &77, &4C, &50, &06, &77, &48, &50
	EQUB &06, &77, &50, &54, &06, &66, &58, &5C
	EQUB &06, &66, &5C, &60, &06, &66, &60, &58  ; D.B. on roof
	EQUB &06, &66, &64, &68, &06, &66, &68, &6C
	EQUB &06, &66, &64, &6C, &06, &66, &6C, &70
	EQUB &05, &33, &74, &78, &05, &33, &7C, &80  ; skids
	EQUB &07, &00, &84, &88, &04, &00, &88, &8C  ; thruster
	EQUB &04, &00, &8C, &90, &04, &00, &90, &84

; -----------------------------------------------------------------------------
; Faces data
; -----------------------------------------------------------------------------
.ship_transporter_faces
	EQUB &3F, &00, &00, &67, &BF, &6F, &30, &07
	EQUB &FF, &69, &3F, &15, &5F, &00, &22, &00
	EQUB &7F, &69, &3F, &15, &3F, &6F, &30, &07
	EQUB &1F, &08, &20, &03, &9F, &08, &20, &03
	EQUB &92, &08, &22, &0B, &9F, &4B, &20, &4F
	EQUB &1F, &4B, &20, &4F, &12, &08, &22, &0B
	EQUB &1F, &00, &26, &11, &1F, &00, &00, &79
