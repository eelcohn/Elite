; -----------------------------------------------------------------------------
; Elite - Python (pirate) data (type &1A)
; written by David Braben and Ian Bell (c) Acornsoft 1984
; -----------------------------------------------------------------------------

python_pirate_attr = %10001100          ; 1....... bit 7: Escape pod present
...
; -----------------------------------------------------------------------------
.python_pirate_header
	EQUB &02                        ; 0000....: cargo type if scooped: none
	                                ; ....0010: max pieces of debris if destroyed: 2
