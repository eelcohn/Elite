...
.ship_python_edges
	...
	EQUB &1D, &37, &08, &20, &1D, &40, &04, &0C
	EQUB &1D, &62, &0C, &20, &1D, &A7, &08, &24
	EQUB &1D, &84, &0C, &10, &1D, &B6, &0C, &24
	EQUB &05, &88, &0C, &14, &05, &BB, &0C, &28
	EQUB &05, &99, &08, &14, &05, &AA, &08, &28
	EQUB &1F, &A9, &08, &1C, &1F, &B8, &0C, &18
	EQUB &1F, &C8, &14, &18, &1F, &C9, &14, &1C
...
.ship_python_faces
	...
	EQUB &DE, &13, &26, &00, &5E, &13, &26, &00
	EQUB &BE, &19, &25, &0B, &3E, &19, &25, &0B
	EQUB &7E, &19, &25, &0B, &FE, &19, &25, &0B
	EQUB &3E, &00, &00, &70
