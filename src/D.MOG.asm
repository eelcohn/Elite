...
.ship_pointers
	...
	EQUW none_start                 ; Ship type 07: Asteroid
	EQUW none_start                 ; Ship type 08: Splinter
	...
	EQUW adder_start                ; Ship type 14: Adder
	...
	EQUW constrictor_start          ; Ship type 1F: Constrictor
...
.ship_attr                              ; Ship attributes:
	...
	EQUB none_attr                  ; Ship type 7: Asteroid
	EQUB none_attr                  ; Ship type 8: Splinter
	...
	EQUB adder_attr                 ; Ship type 20: Adder
	...
	EQUB constrictor_attr           ; Ship type 31: Constrictor
...
SAVE "bin/D.MOG", start, end, start, start
