...
.ship_pointers
	...
	EQUW anaconda_start             ; Ship type 0E: Anaconda
	...
	EQUW worm_start                 ; Ship type 17: Worm
...
.ship_attr                              ; Ship attributes:
	...
	EQUB anaconda_attr              ; Ship type 14: Anaconda
	...
	EQUB worm_attr                  ; Ship type 23: Worm
...
.ship_anaconda
	INCLUDE "src/ships/anaconda.asm"
...
SAVE "bin/D.MOL", start, end, start, start
